...
class ActivityQuerySet(SearchQuerySet):
    ...
    def prefetch_reporting_organisations(self):
        from oipa_db.iati.models import ActivityReportingOrganisation, Narrative
    ...
    def prefetch_title(self):
        from oipa_db.iati.models import Narrative
    ...
    def prefetch_descriptions(self):
        from oipa_db.iati.models import Description, Narrative
        narrative_prefetch = Prefetch(
            'narratives',
            queryset=Narrative.objects.select_related('language'))
    ...
    def prefetch_participating_organisations(self):
        from oipa_db.iati.models import ActivityParticipatingOrganisation, Narrative
        narrative_prefetch = Prefetch(
            'narratives',
            queryset=Narrative.objects.select_related('language'))
    ...
    def prefetch_other_identifiers(self):
        from oipa_db.iati.models import OtherIdentifier, Narrative
        narrative_prefetch = Prefetch(
            'narratives',
            queryset=Narrative.objects.select_related('language'))
    ...
    def prefetch_activity_dates(self):
        from oipa_db.iati.models import ActivityDate
    ...
    def prefetch_contact_info(self):
        from oipa_db.iati.models import ContactInfo, Narrative
    ...
    def prefetch_recipient_countries(self):
        from oipa_db.iati.models import ActivityRecipientCountry
    ...
    def prefetch_recipient_regions(self):
        from oipa_db.iati.models import ActivityRecipientRegion
    ...
    def prefetch_locations(self):
        from oipa_db.iati.models import Location, LocationAdministrative
        from oipa_db.iati.models import Narrative
    ...
    def prefetch_sectors(self):
        from oipa_db.iati.models import ActivitySector
    ...
    def prefetch_country_budget_items(self):
        from oipa_db.iati.models import CountryBudgetItem
    ...
    def prefetch_humanitarian_scope(self):
        from oipa_db.iati.models import HumanitarianScope
    ...
    def prefetch_policy_markers(self):
        from oipa_db.iati.models import ActivityPolicyMarker, Narrative
        narrative_prefetch = Prefetch(
            'narratives',
            queryset=Narrative.objects.select_related('language'))
    ...
    def prefetch_budgets(self):
        from oipa_db.iati.models import Budget
    ...
    def prefetch_planned_disbursement(self):
        from oipa_db.iati.models import PlannedDisbursement
    ...
    def prefetch_document_links(self):
        from oipa_db.iati.models import DocumentLink, DocumentLinkCategory, \
    ...
    def prefetch_related_activities(self):
        from oipa_db.iati.models import RelatedActivity
    ...
    def prefetch_legacy_data(self):
        from oipa_db.iati.models import LegacyData
    ...
    def prefetch_results(self):
        from oipa_db.iati.models import Result, Narrative, ResultIndicatorPeriod, \
    ...
    def prefetch_crs_add(self):
        from oipa_db.iati.models import CrsAdd, CrsAddOtherFlags
    ...
    def prefetch_fss(self):
        from oipa_db.iati.models import Fss
