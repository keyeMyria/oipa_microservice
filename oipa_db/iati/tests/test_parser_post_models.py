...
from oipa_db.iati.models import BudgetSector, Sector
from oipa_db.iati.parser import post_save
from oipa_db.iati.parser.IATI_2_01 import Parse as Parser_201
from oipa_db.iati.transaction.factories import (
...
from oipa_db.iati_synchroniser.factory.synchroniser_factory import DatasetFactory
from oipa_db.iati_vocabulary.factory.vocabulary_factory import SectorVocabularyFactory
...
class PostSaveActivityTestCase(TestCase):
    ...
    def setUpCountriesRegionsSectors(self):
        ...
        self.r1 = iati_factory.RegionFactory(
            code='998', name='World-wide, unspecified')
        self.s1 = SectorFactory(
            code='15160', name='sector A', vocabulary=self.sector_vocabulary_1)
        self.s2 = SectorFactory(
            code='15161', name='sector B', vocabulary=self.sector_vocabulary_1)
        self.s3 = SectorFactory(
            code='15162', name='sector C', vocabulary=self.sector_vocabulary_2)
        self.s4 = SectorFactory(
            code='15163', name='sector D', vocabulary=self.sector_vocabulary_2)
