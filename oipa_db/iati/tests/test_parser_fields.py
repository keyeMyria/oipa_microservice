...
from oipa_db.iati.parser.IATI_1_03 import Parse as Parser_103
from oipa_db.iati.parser.IATI_1_05 import Parse as Parser_105
from oipa_db.iati.parser.IATI_2_02 import Parse as Parser_202
from oipa_db.iati.parser.parse_manager import ParseManager
from oipa_db.iati.transaction import factories as transaction_factory
...
from oipa_db.iati_vocabulary.factory import vocabulary_factory
...
class ActivityTestCase(ParserSetupTestCase):
    ...
    def test_activity_linked_data_uri_inherited(self):
        """
        Check linked-data-uri is inherited from oipa_db.iati-activities if set
        """
