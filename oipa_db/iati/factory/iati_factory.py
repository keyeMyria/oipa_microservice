...
import oipa_db.geodata
import oipa_db.iati
import oipa_db.iati_organisation
from oipa_db.iati_codelists.factory.codelist_factory import (
...
class NarrativeMixin(NoDatabaseFactory):
    ...
    def _generate(cls, create, attrs):
        ...
        narrative = oipa_db.iati.models.Narrative()
        narrative.related_object = instance
        # need a dummy activity (else cyclic)
        narrative.activity = oipa_db.iati.models.Activity.objects.all()[0]
...
class OrganisationNameFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.OrganisationName
        django_get_or_create = ('organisation',)


class OrganisationFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.Organisation
...
class RegionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.geodata.models.Region
...
class CountryFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.geodata.models.Country
        django_get_or_create = ('code', )
...
class CityFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.geodata.models.City
...
class ActivityDummyFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Activity
        django_get_or_create = ('iati_identifier',)
...
class NarrativeFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Narrative
...
class TitleFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Title
...
class DescriptionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Description
...
class ContactInfoOrganisationFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ContactInfoOrganisation


class ContactInfoDepartmentFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ContactInfoDepartment


class ContactInfoPersonNameFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ContactInfoPersonName


class ContactInfoJobTitleFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ContactInfoJobTitle


class ContactInfoMailingAddressFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ContactInfoMailingAddress


class ContactInfoFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ContactInfo
...
class RelatedActivityFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.RelatedActivity
...
class LegacyDataFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.LegacyData

    activity = SubFactory(ActivityFactory)
    name = "value"
    value = "value"
    oipa_db.iati_equivalent = "activity-id"


class OrganisationDocumentLinkTitleFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.DocumentLinkTitle


class OrganisationDocumentLinkFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.OrganisationDocumentLink
...
class OrganisationDocumentLinkCategoryFactory(NoDatabaseFactory):
    ...
    class Meta:
        model = oipa_db.iati_organisation.models.OrganisationDocumentLinkCategory
...
class OrganisationDocumentLinkLanguageFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.OrganisationDocumentLinkLanguage
...
class OrganisationDocumentLinkRecipientCountryFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.DocumentLinkRecipientCountry
...
class DocumentLinkTitleFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.DocumentLinkTitle


class DocumentLinkFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.DocumentLink
...
class DocumentLinkCategoryFactory(NoDatabaseFactory):
    # TODO: eliminate need for this element
    class Meta:
        model = oipa_db.iati.models.DocumentLinkCategory
...
class DocumentLinkLanguageFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.DocumentLinkLanguage
...
class DocumentFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Document
...
class DocumentSearchFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.DocumentSearch
...
class BudgetFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Budget
...
class PlannedDisbursementFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.PlannedDisbursement
...
class PlannedDisbursementProviderFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.PlannedDisbursementProvider
...
class PlannedDisbursementReceiverFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.PlannedDisbursementReceiver
...
class ActivityDateFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ActivityDate
...
class OrganisationTotalBudgetFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.TotalBudget
...
class OrganisationTotalBudgetLineFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.TotalBudgetLine
...
class OrganisationRecipientCountryBudgetFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.RecipientCountryBudget
...
class OrganisationRecipientCountryBudgetLineFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.RecipientCountryBudgetLine
...
class OrganisationRecipientRegionBudgetFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.RecipientRegionBudget
...
class OrganisationRecipientRegionBudgetLineFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.RecipientRegionBudgetLine
...
class OrganisationTotalExpenditureFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.TotalExpenditure
...
class OrganisationTotalExpenditureLineFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.TotalExpenditureLine
...
class OrganisationRecipientOrgBudgetFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.RecipientOrgBudget
...
class OrganisationRecipientOrgBudgetLineFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.RecipientOrgBudgetLine
...
class OrganisationReportingOrganisationFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.OrganisationReportingOrganisation
...
class OrganisationNarrativeFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati_organisation.models.OrganisationNarrative
...
class ParticipatingOrganisationFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ActivityParticipatingOrganisation
...
class OtherIdentifierFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.OtherIdentifier
...
class ReportingOrganisationFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ActivityReportingOrganisation
...
class ActivitySectorFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ActivitySector
...
class ActivityRecipientCountryFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ActivityRecipientCountry
...
class ActivityRecipientRegionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ActivityRecipientRegion
...
class CountryBudgetItemFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.CountryBudgetItem
...
class BudgetItemDescriptionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.BudgetItemDescription


class BudgetItemFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.BudgetItem
...
class ActivityPolicyMarkerFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ActivityPolicyMarker
...
class ResultTitleFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultTitle


class ResultDescriptionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultDescription


class LocationNameFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.LocationName


class LocationDescriptionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.LocationDescription


class LocationActivityDescriptionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.LocationActivityDescription


class LocationFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Location
...
class LocationAdministrativeFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.LocationAdministrative
...
class ResultFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Result
...
class ResultIndicatorTitleFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorTitle
...
class ResultIndicatorDescriptionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorDescription
...
class ResultIndicatorBaselineCommentFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorBaselineComment
...
class ResultIndicatorFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicator
...
class ResultIndicatorReferenceFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorReference
...
class ResultIndicatorPeriodTargetCommentFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorPeriodTargetComment


class ResultIndicatorPeriodActualCommentFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorPeriodActualComment


class ResultIndicatorPeriodFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorPeriod
...
class ResultIndicatorPeriodActualLocationFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorPeriodActualLocation
...
class ResultIndicatorPeriodTargetLocationFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorPeriodTargetLocation
...
class ResultIndicatorPeriodActualDimensionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorPeriodActualDimension
...
class ResultIndicatorPeriodTargetDimensionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.ResultIndicatorPeriodTargetDimension
...
class HumanitarianScopeFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.HumanitarianScope
    ...
    vocabulary_uri = "http://reference.iatistandard.org/202/activity-standard/\
                      oipa_db.iati-activities/iati-activity/humanitarian-scope/"
...
class ActivitySearchFactory(ActivityFactory):
    ...
    id = 'IATI-search'
    oipa_db.iati_identifier = 'IATI-search'
...
class ConditionsFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Conditions
...
class ConditionFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.Condition
...
class CrsAddLoanTermsFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.CrsAddLoanTerms
...
class CrsAddLoanStatusFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.CrsAddLoanStatus
...
class CrsAddFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.CrsAdd
...
class CrsAddOtherFlagsFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.CrsAddOtherFlags
...
class FssForecastFactory(NoDatabaseFactory):
    class Meta:
        model = oipa_db.iati.models.FssForecast
