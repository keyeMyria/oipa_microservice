...
from oipa_db.currency_convert import convert
from oipa_db.geodata.models import Country, Region
# FIXME:
from oipa_db.iati import models
from oipa_db.iati.parser import post_save, post_save_validators
...
from oipa_db.iati.parser.higher_order_parser import provider_org, receiver_org
from oipa_db.iati.parser.iati_parser import IatiParser
from oipa_db.iati.transaction import models as transaction_models
...
from oipa_db.iati_vocabulary import models as vocabulary_models
...
class Parse(IatiParser):
    ...
    def iati_activities__iati_activity__related_activity(self, element):
        ...
        # At least remove starting / ending spaces from oipa_db.iati_identifier
