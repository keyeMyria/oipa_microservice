...
class Parse(IATI_105_Parser):
    ...
    def iati_activities__iati_activity__location__administrative(
        ...
        if adm1:
            ...
            elem = E('administrative', code=country,
                     vocabulary="A2", level="1")
            super(Parse, self)\
                .iati_activities__iati_activity__location__administrative(
                    elem
                )
    ...
    def iati_activities__iati_activity__location__coordinates(self, element):
        ...
        super(
            Parse, self
        ).iati_activities__iati_activity__location__point(point)
        # ISO Country (3166-1 alpha-2)
        pos = E('pos', latitude + ' ' + longitude)
        super(
            Parse, self
        ).iati_activities__iati_activity__location__point__pos(pos)
        ...
        if precision:
            ...
            super(
                Parse, self
            ).iati_activities__iati_activity__location__exactness(
                exactness
            )
