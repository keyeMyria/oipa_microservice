...
class LocationQuerySet(models.QuerySet):
    ...
    def prefetch_administrative(self):
        from oipa_db.iati.models import LocationAdministrative
    ...
    def prefetch_name(self):
        from oipa_db.iati.models import LocationName, Narrative
    ...
    def prefetch_description(self):
        from oipa_db.iati.models import LocationDescription, Narrative
        narrative_prefetch = Prefetch(
            'narratives',
            queryset=Narrative.objects.select_related('language'))
    ...
    def prefetch_activity_description(self):
        from oipa_db.iati.models import LocationActivityDescription, Narrative
        narrative_prefetch = Prefetch(
            'narratives',
            queryset=Narrative.objects.select_related('language'))
